...
async function generateResumePdf( resume, selfDescription, jobDescription){
    ...
    const prompt = `Generate a resume PDF for a candidate with the following details
                       ...
                       the resume should not be lengthy , it should be ideally 1-2 pages long when converted to pdf . focus on quality rather than quantity and make sure to include all the relevant information that can increase the candidate's chance of getting an interview call for the given job description.  
                       `
